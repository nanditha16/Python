...
# Edge Case Handling
#     Empty matrix → handled by early return
#     Negative values → supported
#     Multiple queries → efficient due to precomputation
...
class NumMatrix:
    def __init__(self, matrix: List[List[int]]):  
        ...
        # Create a prefix sum matrix with extra row and column (0-indexed padding)
